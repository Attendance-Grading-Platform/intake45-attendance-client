...
feature/billing-and-grades-haneen
    ...
    datasets: [
      {
        data: values,
        backgroundColor: [
          '#059669', // Excellent  — emerald-600
          '#0891b2', // Very Good  — cyan-600
          '#2563eb', // Good       — blue-600
          '#d97706', // Pass       — amber-600
          '#dc2626', // Fail       — red-600
        ],
        borderColor: '#ffffff',
        borderWidth: 2,
        ...
        <template v-if="hasActiveSession">
          <div class="flex items-start justify-between flex-wrap gap-4">
            <div>
              ...
              <h2 class="font-serif text-h2 text-neutral-900 mb-2">
