            ...
            >
                ...
                >
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button
                            type="button"
                            class="h-[38px] px-4 text-sm font-sans rounded-[6px] bg-brand-red text-brand-surface hover:bg-[#7a0002] transition-colors disabled:opacity-60 flex items-center gap-2"
                            :disabled="loading"
                            @click="emit('confirm')"
                        >
